...
export default class AmSelectedVehicles extends NavigationMixin(LightningElement)  
{
    ...
    handleQuote(event)
  {
    ...
    alert(this.customerID1);
    alert('before'+this.selectedCars1);
    this.selectedCars1=[];
    alert('after'+this.selectedCars1);
    this.selectedCars1.append(this.selectedId1);
    alert(this.selectedCars1);
    ...
    /*
    //vol.append(volume*)
    //this.selectedCars1.add(this.selectedId1);
    let compDefinition = {
        componentDef: "c:discountcomp",
        attributes: {
            selectCustomer :this.customerID1 ,
