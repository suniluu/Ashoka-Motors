...
const columns = [
  ...
  { label: 'Profit Sold', fieldName: 'priceSold' ,sortable: "true",type:'currency'},
...
export default class CarSales extends NavigationMixin(LightningElement) 
{
  ...
  @wire(getCarSalesListWrapper,{searchTerm: '$searchTerm',searchTerm2:'$getmonth',searchTerm3:'$getYear'}) 
  wiredCases({ error, data }) 
  {
    ...
    if (actionName !== 'all') {
        ...
        this.cases = this.ALL_CASES.filter(record => record.brand === actionName);
    } else {
