...
const columns = [
  ...
  { label: 'Brand', fieldName: 'brand' ,sortable: "true",  actions: [{ label: 'All', checked: true, name: 'all' },
  { label: 'Tata', checked: false, name: 'Tata' },
  { label: 'Hyundai', checked: false, name: 'Hyundai' },
  { label: 'Mahindra', checked: false, name: 'Mahindra' }]},
